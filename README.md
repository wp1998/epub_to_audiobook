...
*2025-2-13* 新增了腾讯云TTS服务-长文本语音合成的支持
...
4. Set the following environment variables with your Azure Text-to-Speech API credentials, or your OpenAI API key if you're using OpenAI TTS:
    ...
    export TC_SECRET_ID=<your secretId> # for tencent cloud
    export TC_SECRET_KEY=<your secretKey> # for tencent cloud
    ```
...
options:
  ...
  --tts {azure,openai,edge,piper,tencentcloud}
  ...
  --voice_name VOICE_NAME
                        ...
                        使用腾讯云TTS时，此参数对应长文本语音合成音色（如 501003/智宇/大模型音色），
                        查看列表：https://cloud.tencent.com/document/product/1073/92668
